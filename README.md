...
As you can see, I have explored quite a few diverse fields. However after trying my hands on quite a few of them, I decided to focus and strengthen my grasp on a few select subjects which include Statistics and Machine Intelligence, with a particular focus on Computer Vision and Natural Language Processing, Graph Theory and Network Analysis, and Quantitative Economics along with Financial Risk Management.
